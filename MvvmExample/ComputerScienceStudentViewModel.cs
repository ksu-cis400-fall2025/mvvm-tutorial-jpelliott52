...
namespace MvvmExample
{
    public class ComputerScienceStudentViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>The student's Compuet Science GPA</summary>
        ...
        /// <summary>
        /// Event handler for handing pass-forward events from the student
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new ComputerScienceStudentViewModel that wraps <paramref name="student"/>
        /// </summary>
        /// <param name="student">The student wrapped in this model</param>
